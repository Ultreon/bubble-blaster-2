...
public record Screenshot(FileHandle fileHandle) {
    public static Screenshot take() {
        ...
        FileHandle fileHandle = Gdx.files.local(String.format("screenshots/screenshot_%s.png", DateTimeFormatter.ofPattern("MM.dd.yyyy-HH.mm.ss").format(LocalDateTime.now())));

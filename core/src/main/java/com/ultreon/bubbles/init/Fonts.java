...
public class Fonts {
    ...
    public static final RegistrySupplier<BitmapFont> SANS_BOLD_ITALIC_10 = register("sans_bold_italic_10", () -> FontUtils.createBitmapFont(BubbleBlaster.id("noto_sans/noto_sans_bold_italic"), 10));

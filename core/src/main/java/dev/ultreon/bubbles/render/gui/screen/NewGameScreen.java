...
public class NewGameScreen extends Screen {
    ...
    public void renderBackground(Renderer renderer) {
        ...
        renderer.drawTextCenter(Fonts.SANS_HEADER_1.get(), TextObject.translation("bubbleblaster.screen.newGame.title"), this.width / 2f, 60, Colors.rgba(0xff, 0xff, 0xff, 0x80));
        renderer.drawTextRight(Fonts.SANS_PARAGRAPH_BOLD.get(), TextObject.translation("bubbleblaster.screen.saves.create.seed"), this.width / 2f - 160, this.seedEntry.getY() + 24, Colors.rgba(0xff, 0xff, 0xff, 0x80));
        renderer.drawTextRight(Fonts.SANS_PARAGRAPH_BOLD.get(), TextObject.translation("bubbleblaster.screen.saves.create.gamemode"), this.width / 2f - 160, this.gamemodeList.getY() + 24, Colors.rgba(0xff, 0xff, 0xff, 0x80));
        renderer.drawTextRight(Fonts.SANS_PARAGRAPH_BOLD.get(), TextObject.translation("bubbleblaster.screen.saves.create.difficulty"), this.width / 2f - 160, this.difficultyList.getY() + 24, Colors.rgba(0xff, 0xff, 0xff, 0x80));
    }
}

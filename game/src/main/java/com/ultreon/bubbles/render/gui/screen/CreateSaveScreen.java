...
public class CreateSaveScreen extends Screen {
    ...
    @Override
    public void init() {
        Label label = add(new Label(new TranslationText("bubbles/saves/create/title"), this.width / 2 - 150, 0, 300, 50));
        label.setFontSize(36);

        Label label1 = add(new Label(new TranslationText("bubbles/saves/create/seed"), this.width / 2 - 150, 50, 300, 30));
        label1.setFontSize(20);

        Label label2 = add(new Label(new TranslationText("bubbles/saves/create/gamemode"), this.width / 2 - 150, 95, 300, 25));
        ...
        this.createBtn = add(new OptionsButton.Builder()
                ...
                .text(new TranslationText("bubbles/screen/saves/create/button"))
                .command(this::create)
                .build());
    }
...
//        font.draw(renderer, new TranslationText("bubbles/saves/create/title"), 36, width / 2f, height / 2f - 30, Thickness.BOLD, Anchor.S);
//        font.draw(renderer, new TranslationText("bubbles/saves/create/seed"), 36, width / 2f - 20, height / 2f + 15, Thickness.BOLD, Anchor.E);
//        font.draw(renderer, new TranslationText("bubbles/saves/create/gamemode"), 36, width / 2f - 20, height / 2f + 55, Thickness.BOLD, Anchor.E);
    }

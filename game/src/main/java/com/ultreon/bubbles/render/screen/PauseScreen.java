...
public class PauseScreen extends Screen {
    ...
    public void render(BubbleBlaster game, Renderer renderer, float partialTicks) {
        ...
        //     Darkened background     //
        /////////////////////////////////
        renderer.color(new Color(0, 0, 0, 192));
        ...
        // Bubble name.
        renderer.color(new Color(255, 255, 255, 192));
        ...
        // Bubble icon.
        EnvironmentRenderer.drawBubble(renderer, (int) (BubbleBlaster.getMiddleX() - 470), 350, 122, bubble.colors);
        ...
        renderer.text(Double.toString(MathHelper.round(bubble.getMinSpeed(), 5)), (int) (BubbleBlaster.getMiddleX() - 326) + 200, 402);
        renderer.text(Double.toString(MathHelper.round(bubble.getMaxSpeed(), 5)), (int) (BubbleBlaster.getMiddleX() - 326) + 200, 422);
        renderer.text(MathHelper.round((double) 100 * BubbleSystem.getDefaultPercentageChance(bubble), 5) + "%", (int) (BubbleBlaster.getMiddleX() - 326) + 200, 442);
        renderer.text(MathHelper.round((double) 100 * BubbleSystem.getPercentageChance(bubble), 5) + "%", (int) (BubbleBlaster.getMiddleX() - 326) + 200, 462);
        ...
        if (bubble.isScoreRandom()) {
            ...
            renderer.text(Double.toString(MathHelper.round(bubble.getScore(), 5)), (int) (BubbleBlaster.getMiddleX() + 72) + 200, 402);
        }
        if (bubble.isAttackRandom()) {
            renderer.text(random, (int) (BubbleBlaster.getMiddleX() + 72) + 200, 422);
        } else {
            renderer.text(Double.toString(MathHelper.round(bubble.getAttack(), 5)), (int) (BubbleBlaster.getMiddleX() + 72) + 200, 422);
        }
        if (bubble.isDefenseRandom()) {
            renderer.text(random, (int) (BubbleBlaster.getMiddleX() + 72) + 200, 442);
        } else {
            renderer.text(Double.toString(MathHelper.round(bubble.getDefense(), 5)), (int) (BubbleBlaster.getMiddleX() + 72) + 200, 442);
        }
